...
function preload(){
  ...
  background1image = loadImage("backg.jpg");
}

function setup() {
  createCanvas(600, 500);
  background1 = createSprite(300,200,10,10);
  ...
  ground = createSprite(0,410,1200,10);
...
function spawnCoin() {
  ...
  if (frameCount % 60 === 0) {
    var coin = createSprite(600,320,40,10);
    coin.y = Math.round(random(260,300));
